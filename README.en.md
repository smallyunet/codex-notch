...
- The app bundle carries an original warm-ivory, black-notch, command-slot icon. Its minimal status dot takes inspiration from the supplied reference without copying its branding. It is recognizable in Finder, Launchpad, and the installer, and never uses account or conversation data.
